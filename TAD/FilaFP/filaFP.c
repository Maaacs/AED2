...
void* desenfileirar_FP (TFilaPrioridade* f){ // nesse formato TFila* f pq queremos trazer um cara
    ...
    //validar a propriedade da ordem
    int i, imaior = 0; // i e imaior está no pai
    
    do{ // toda vez que encontro um filho maior na esquerda ou a direita, eu devo trocar pelo pai
        i = imaior;
        int iesq = 2*i+1; // filho a esquerda
        int idir = 2*i+2; // filho a direita
