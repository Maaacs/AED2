...
void imprimirInfo(TInfo info){
  ...
  printf("%ld %lf %d %lf\n", info.rg, info.altura, info.idade, info.peso);
...
int main(int argc, char const *argv[]) {
  ...
  while(rg > 0){
    scanf("%lf %d %lf", &altura, &idade, &peso);
    //instanciado estrutura inicializando os seus membros
